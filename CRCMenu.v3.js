...
const createRightClickMenu = () => {
    ...
    const menu = new CustomRightClickMenu({
        ...
        /*theme: {
            ...
            // 对应菜单重复触发行为：'translate' (平移, 默认) 或 're-show' (隐藏并重新显示)
            '--reopen-behavior': 'translate',
            // 对应是否禁止在菜单内二次右键：true (禁止, 默认) 或 false (允许)
