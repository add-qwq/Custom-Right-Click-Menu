...
### Custom Right-Click Menu (V2)
We are confident that this project is the **most complete and refined native JavaScript custom right-click menu** (as of the project's commit time) — no framework dependencies required. Of course, many excellent developers may simply not have ventured into such tools; we have merely turned this idea into a practical, implementable solution.
...
### 自定义右键菜单（V2）
我们有信心称该项目是目前为止（具体时间以项目commits时间为准），功能最完善、最优秀的**原生JavaScript自定义右键菜单**——无需依赖任何框架
